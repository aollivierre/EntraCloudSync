...
#   $containerInclusions = @(
#     "DC=cb,DC=tunngavik,DC=local"
# )

#   $containerExclusions= @(
#     "CN=LostAndFound,DC=cb,DC=tunngavik,DC=local",
#     "CN=Microsoft Exchange System Objects,DC=cb,DC=tunngavik,DC=local",
#     "OU=Microsoft Exchange Security Groups,DC=cb,DC=tunngavik,DC=local",
#     "CN=Managed Service Accounts,DC=cb,DC=tunngavik,DC=local",
#     "OU=NotSyncedtoEID,DC=cb,DC=tunngavik,DC=local",
#     "CN=Program Data,DC=cb,DC=tunngavik,DC=local",
#     "CN=System,DC=cb,DC=tunngavik,DC=local"
#   )



  $containerInclusions = @(
    "DC=ri,DC=nti,DC=local"
)

  $containerExclusions= @(
 "CN=LostAndFound,DC=ri,DC=nti,DC=local",
    "CN=Managed Service Accounts,DC=ri,DC=nti,DC=local",
    "OU=Microsoft Exchange Security Groups,DC=ri,DC=nti,DC=local",
    "CN=Microsoft Exchange System Objects,DC=ri,DC=nti,DC=local",
    "OU=NotSyncedtoEID,DC=ri,DC=nti,DC=local",
    "CN=System,DC=ri,DC=nti,DC=local",
    "CN=Program Data,DC=ri,DC=nti,DC=local",
    "OU=NotSyncedContactsEID,DC=ri,DC=nti,DC=local"
  )
