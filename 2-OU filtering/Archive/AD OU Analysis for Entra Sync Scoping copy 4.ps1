...
Write-Host "Total Users: $(($allOUsAndContainers | Measure-Object -Property UserCount -Sum).Sum)"
Write-Host "Total Contacts: $(($allOUsAndContainers | Measure-Object -Property ContactCount -Sum).Sum)"
Write-Host "Total Groups: $(($allOUsAndContainers | Measure-Object -Property GroupCount -Sum).Sum)"
Write-Host "Total Computers: $(($allOUsAndContainers | Measure-Object -Property ComputerCount -Sum).Sum)"
